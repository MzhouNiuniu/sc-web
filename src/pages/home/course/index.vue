        ...
        <div class="content-wrapper">
            <div class="operate-bar">
                ...
                <div>
                    <el-button
                        type="primary"
                        @click="$router.push('/home/editCourse')"
                    >新增
                    </el-button>
                </div>
            </div>
            ...
            >
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <ABth :item="scope.row" :url="api.course.changeStatus"/>
                        <SBth :item="scope.row" url="/home/editCourse"></SBth>
                        <EBth :item="scope.row" url="/home/editCourse"></EBth>
                        <DBth :item="scope.row"  :url="api.course.deleteById"/>
                        <STBth :item="scope.row"  :url="api.course.changeStick"/>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination
    ...
    export default {
        ...
        methods: {
            ...
            async getList(){
                ...
                const res = await this.http.get(this.api.course.getList,params)
