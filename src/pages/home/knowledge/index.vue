        ...
        <div class="content-wrapper">
            <div class="operate-bar">
                ...
                <div>
                    <el-button
                        type="primary"
                        @click="$router.push('/home/editknowledge')"
                    >新增
                    </el-button>
                </div>
            </div>
            ...
            >
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <ABth :item="scope.row" :url="api.knowledge.changeStatus"/>
                        <SBth :item="scope.row" url="/home/editknowledge"></SBth>
                        <EBth :item="scope.row" url="/home/editknowledge"></EBth>
                        <DBth :item="scope.row"  :url="api.knowledge.deleteById"/>
                        <STBth :item="scope.row"  :url="api.knowledge.changeStick"/>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination
