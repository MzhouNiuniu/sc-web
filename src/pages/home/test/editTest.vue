    ...
    export default {
        ...
        methods: {
                ...
                this.$refs['form'].validate( async(valid) => {
                    if (valid) {
                        ...
                        if(this.$route.query.id){
                            res = await this.http.post(this.api.test.changeInFo,this.seedling)
                        }
                        else{

                            res = await this.http.post(this.api.test.publish,this.seedling)
                        }
                        if(res.code==200){
            ...
            async getDetailsById(id){
                const res = await this.http.get(this.api.test.getDetailsById,{id})
